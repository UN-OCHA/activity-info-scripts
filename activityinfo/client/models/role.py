...
class Role(BaseModel):
    ...
    id: StrictStr
    label: StrictStr
    permissions: Optional[List[FilteredPermission]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "label": obj.get("label"),
            "permissions": [FilteredPermission.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
