...
class UpdateDatabaseUserRoleDTO(BaseModel):
    ...
    """ # noqa: E501
    assignments: List[DatabaseRole]
    __properties: ClassVar[List[str]] = ["assignments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignments": [DatabaseRole.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None
        })
        return _obj
